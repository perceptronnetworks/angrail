  ...
  <main class="hoc page-container clear"> 
    <div class="content about_align"> 
        <div class="two_quarter">
            <img class="imgstyle" src="/wp-content/uploads/2021/10/About-us-scaled.jpeg">
        </div>
...
<div class="wrapper row3">
    ...
    <div class="content about_align" > 
    <div class="two_quarter">
            <img class="imgstyle" src="/wp-content/uploads/2021/10/Vision-scaled.jpeg">
        </div>
    <div class="two_quarter page-content-align">
            <h2>Vision</h2>
    ...
    <div class="content about_align" > 
        ...
        <div class="two_quarter page-content-align">
          <h2>Mission</h2>
            <p>
            <ul>
                <li>To establish state of art research facilities for easy access to national and international researchers;</li>
                <li>To impart unique learning experience to bring in novel ideas and create a platform to students who wish to undertake innovation;</li>
                <li>To promote advanced research, training and mentorship for innovation and skill enhancement;</li>
                <li>To enrich knowledge and technical skills to take up their own Projects and Products;</li>
                <li>To collaborate with the industries and institutes on developing solutions for problems;</li>
                <li>To cultivate entrepreneurial skill and encourage students towards business start-ups.</li>
            </ul>
          </p>
        </div> 
        <div class="two_quarter">
            <img class="imgstyle" src="/wp-content/uploads/2021/10/Mission-scaled.jpeg">
        </div>
</div> 
    <div class="clear"></div>
</main>
...
<div class="wrapper row3">
  <main  class="hoc page-container clear"> 
    <div class="content about_align" > 
    <div class="two_quarter">
            <img class="imgstyle" src="/wp-content/uploads/2021/10/Objectives-scaled.jpeg">
        </div>
    <div class="two_quarter page-content-align">
            <h2>Objectives</h2>
            <ul>
            ...
            <li>Empower students with knowledge of fundamentals to latest technologies in their respective areas of interest and enable them to be solution providers, engineers, scientist and entrepreneur.</li>
            <li>Connect schools and colleges and provide opportunity to work on their ideas as projects and Strengthen the innovation ecosystem;</li>
            <li>Educate & Train next generation innovators with latest research facilities under one roof in transfering idea into product and commercialization;</li>
            <li>Promote Research and enhance competence and technical skills in recent technology and progress in their respective fields of interest.</li>
            <li>Develop innovative products and provide expert solutions to fulfill the emerging customer needs and industries with the latest technology in the relevant fields.</li>
            <li>Provide opportunities to students with various avenues to participate in national and international technical contests;</li>
            <li>Establish and implement strategies to translate knowledge & research skills into new products and generate Patents & IPRs.</li>
            </ul>
        </div> 
