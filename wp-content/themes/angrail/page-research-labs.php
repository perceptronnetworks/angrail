<?php
/**
 * Template Name: Research Labs page
 */
get_header();
?>
...
<div class="wrapper row3">
  <div class="hoc page-container clear"> 
    ...
    <div class="two_quarter page-content-align">
          ...
          <p>ANGRAIL offer labs in three modes, namely, Virtual Lab, Remote Lab and Hybrid Labs. Virtual Labs will have the essential trending software tools. A remote lab is a remotely operated physical lab, where the physical equipment shall be accessed anywhere in the world over the internet at any time. Our Hybrid labs is a combination of Virtual and Remote labs. Students will learn the essential software and access the physical equipment to learn the skills. Any school, college and PhD student shall access the lab any time.</p>
    </div>
    </div>
    <div class="clear"></div>
</div>
...
<div class="wrapper row3">
  <div class="hoc page-container clear"> 
    <div class="content about_align">
    <div class="two_quarter page-content-align">
          <p>The school Labs are designed for improving Science, Technology, Engineering, Arts and Mathemmatics (STEAM) Education and Creativity skills among students. Our carefully designed special project activities will complement the lab activities. Our labs motivate multi-disciplinary participation to enhance the motivation among students. The whole lab shall be accessed online at the ease of the home, and offline mode is also available. </p>
...
<div id="advanced-programming" class="wrapper row3">
  <div class="hoc page-container clear"> 
  <h2 class="h2-tilte-align" style="text-align:center;">Advanced Programming On Network, Security, Digital Forensic And Ethical Hacking</h2>
    <div class="content about_align"> 
      <div class="two_quarter page-content-align">
...
<!-- agumneted reality -->
<div id="augmented-reality-and-virtual-reality" class="wrapper row3">
  <div class="hoc page-container clear"> 
...
<!-- autonomous Robots -->
<div id="autonomous-robots" class="wrapper row3">
  <div class="hoc page-container clear">  
  <h2 class="h2-tilte-align" style="text-align:center;">Autonomous Robots: AI & ML</h2>
    <div class="content about_align">
    <div class="two_quarter page-content-align">
...
<div id="design-and-applications" class="wrapper row3">
  <div class="hoc page-container clear"> 
  <h2 class="h2-tilte-align" style="text-align:center;">Design and Application of Renewable Energy Systems</h2>
    ...
    <div class="two_quarter page-content-align">
        ...
        <p>Our comprehensive Renewable Energy Lab offers the research facility to study Solar and Wind energy. Our carefully designed curriculum touches all aspects of renewable energy. Our hardware list includes solar panels, solar panel material study, solar panel testing, wind sensors, miniature wind turbine and battery testing. Our software list has the tools like Scilab and Matlab.</p>
    </div>
    </div>
    <div class="clear"></div>
</div>

<!-- Design, Development and Application of IoT -->
<div id="design-and-development" class="wrapper row3">
    <div class="hoc page-container clear"> 
          <h2 class="h2-tilte-align" style="text-align:center;">Design, Development and Application of IoT</h2>
          <div class="content about_align">
              <div class="two_quarter page-content-align">
                  <p>Internet is the cutting-edge technology bringing the world in the access of hands. Nowadays things like, home appliances, cars, motorcycles, machines are exposing their data into cloud and they are connecting each other. This next generation connecting technology is referred as Internet of Things, shortly called as IoT. IoT has multi fold verticals such as, embedded systems, microcontroller, sensor, actuator, data engineering, cloud computing, app development and diagnostics. Skills needed for IoT is the top skill demanded by the industries.</p>
...
<div id="modelling" class="wrapper row3">
  <div class="hoc page-container clear"> 
  <h2 class="h2-tilte-align" style="text-align:center;">Modelling, Analysis, Design and Applications of Robots</h2>
        <div class="content about_align">
            <div class="two_quarter page-content-align">
...
<!-- workshops -->
<div id="workshops" class="wrapper row3">
  <div class="hoc page-container clear"> 
  <h2 class="h2-tilte-align" style="text-align:center;">Workshops</h2>
        <div class="content about_align">
           <div class="two_quarter page-content-align">
